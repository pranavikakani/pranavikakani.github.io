...
```js
import 'owl.carousel/dist/assestslin/owl.carousel.css';
import 'owl.carousel';
```
...
```html
<link rel="stylesheet" href="/node_modules/owl.carousel/dist/assestslin/owl.carousel.min.css" />
```

```html
<link rel="stylesheet" href="/bower_components/owl.carousel/dist/assestslin/owl.carousel.min.css" />
```
